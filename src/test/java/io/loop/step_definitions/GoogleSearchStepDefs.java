...
public class GoogleSearchStepDefs {
    ...
    public void user_should_see_loop_academy_google_search_in_the_google_title() throws InterruptedException {
        WebDriverWait wait = new WebDriverWait(Driver.getDriver(), Duration.ofSeconds(10));
        wait.until(ExpectedConditions.titleIs("Loop Academy - Google Search"));
        String actualTitle = Driver.getDriver().getTitle();
        assertEquals("Expected result doent match the actual","Loop Academy - Google Search" ,actualTitle );
    }
